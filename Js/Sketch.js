// Dev HoangTran
// 5/2018
// project : visualyze---desi-1528083873913
// short link AIzaSyCezKT8X5-OopG3tdplJDNFiF5KmRZeC04
...
function setup() {
    ...
    if (l.search("[?]") > 0) {
        ...
        loadJSON('default theme/' + VisualizeGui.themes + '.json',
            ...
            // error
            function(e) {
                alert("Can not load this theme, choose another theme in Setting\nERROR:" + e);
...
function mousePressed() {
    if (myAudio && getAudioContext().state !== 'running') {
